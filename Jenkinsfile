    ...
    node('esjenkinspod') {
      ...
      stage('Test') {
          ...
          container('helm') { 
            ...
            // sh 'helm upgrade --install kibana elastic/kibana -f kibana/values.yaml -n $NAMESPACE --create-namespace'
            // sh 'helm upgrade --install metricbeat elastic/metricbeat -f metricbeat/values.yaml -n $NAMESPACE --create-namespace'
            ...
            // sh 'helm uninstall logstash -n $NAMESPACE'
            // sh 'helm uninstall kibana -n $NAMESPACE'
